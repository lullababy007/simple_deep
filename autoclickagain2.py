...
def find_icon_position(image, icon_id, train_labels):
    # 이미지 템플릿 불러오기
    icon_path = f"C:\\Users\\a\\Desktop\\Eng\\{train_labels[icon_id]}\\test{icon_id + 1}.png"
...
def main():
    ...
    icon_position = find_icon_position(screen_image, icon_id, train_labels)
