...
def find_icon_on_screen(icon_name):
    ...
    # OCR 엔진 모드 변경 코드
    custom_config = r'-c tessedit_char_whitelist=ABCDEFGHIJKLMNOPQRSTUVWXYZ --psm 11'
    ...
    if icon_name in text:
        ...
        # 아이콘의 위치를 찾습니다.
        icon_coords = pyautogui.locateCenterOnScreen(r"C:\Users\a\Desktop\Eng\test.png")  # 아이콘 이미지 파일의 절대 경로를 사용합니다.
